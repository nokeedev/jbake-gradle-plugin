...
final class JBakeDefaultLayout implements Action<JBakeExtension> {
	private final Project project;

	public JBakeDefaultLayout(Project project) {
	...
	private Provider<Map<String, Object>> defaultJBakeProperties() {
		return project.provider(this::defaultJBakePropertiesFile).map(new LoadPropertiesFileIfAvailable());
	}

	private FileSystemLocation defaultJBakePropertiesFile() {
		return project.getLayout().getProjectDirectory().file("src/jbake/jbake.properties");
	}
}
